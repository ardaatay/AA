...
using AA.Business.Concrete;
using AA.DataAccess.Abstract;
using AA.DataAccess.Concrete.Mongo;
...
namespace AA.WebUI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<ILeagueDal, MongoLeagueDal>();
            services.AddSingleton<ITeamService, TeamManager>();
            services.AddSingleton<ITeamDal, MongoTeamDal>();
